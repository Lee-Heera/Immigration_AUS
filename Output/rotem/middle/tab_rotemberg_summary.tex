...
\caption{Summary of Rotemberg weights -- Middle Skill Jobs Employment}
\label{apt:rotemberg_mid}
...
$\hat{\alpha}_k$ &  1.000 &  &  &  &  \\
$ &  0.068 &  1.000 &  &  &  \\
$\hat{\beta}_k$ & -0.208 &  0.064 &  1.000 &  &  \\
$\hat{F}_k$ &  0.473 &  0.016 & -0.273 &  1.000 &  \\
Var$(z_k)$ &  0.417 & -0.200 & -0.048 & -0.067 &  1.000 \\ [0.2em]
\multicolumn{6}{l}{\textbf{Panel B: Top 5 Rotemberg weight origin countries}} \\
 & $\hat{\alpha}_k$ & $ & $\hat{\beta}_k$ & 95\% C.I. & \\ \cline{2-5}
IND &   0.082 &   0.231 &  -0.170 & (-0.836,0.497) & \\
NZL &   0.055 &   0.222 &   5.174 & (0.626,9.721) & \\
GBR &   0.048 &  -0.034 &   3.529 & (-3.172,10.230) & \\
CHN &   0.036 &   0.286 &   1.516 & (0.461,2.571) & \\
MYS &   0.028 &   0.036 &  -0.572 & (-2.409,1.264) & \\
\hline\hline
\end{tabular}
}
