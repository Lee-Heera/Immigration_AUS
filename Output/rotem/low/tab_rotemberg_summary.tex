...
\caption{Summary of Rotemberg weights -- Low Skill Jobs Employment}
\label{apt:rotemberg_low}
...
$\hat{\alpha}_k$ &  1.000 &  &  &  &  \\
$ &  0.068 &  1.000 &  &  &  \\
$\hat{\beta}_k$ &  0.115 &  0.049 &  1.000 &  &  \\
$\hat{F}_k$ &  0.473 &  0.016 &  0.226 &  1.000 &  \\
Var$(z_k)$ &  0.417 & -0.200 &  0.040 & -0.067 &  1.000 \\ [0.2em]
\multicolumn{6}{l}{\textbf{Panel B: Top 5 Rotemberg weight origin countries}} \\
 & $\hat{\alpha}_k$ & $ & $\hat{\beta}_k$ & 95\% C.I. & \\ \cline{2-5}
IND &   0.082 &   0.231 &   0.069 & (-0.250,0.389) & \\
NZL &   0.055 &   0.222 &  -3.193 & (-7.148,0.762) & \\
GBR &   0.048 &  -0.034 &  -0.768 & (-3.956,2.421) & \\
CHN &   0.036 &   0.286 &   0.988 & (0.275,1.701) & \\
MYS &   0.028 &   0.036 &   0.016 & (-0.742,0.773) & \\
\hline\hline
\end{tabular}
}
