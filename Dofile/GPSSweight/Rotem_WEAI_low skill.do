...
drop if growlowsk_share == .

tabulate year, generate(year_)

* residualize y
xi: reg growlowsk_share D1_share_popfifold D1_share_college year_2-year_5 i.LGAFINAL21, cl(LGAFINAL21)
predict yhat, xb
gen p_t_res = growlowsk_share - yhat
...
cd "/Users/ihuila/Desktop/data/2025ABS/tables/rotem/low"
est clear
...
save "/Users/ihuila/Desktop/data/2025ABS/tables/rotem/low/panelII_top5_table.dta", replace
...
file write tex "\caption{Summary of Rotemberg weights -- Low Skill Jobs Employment}" _n
file write tex "\label{apt:rotemberg_low}" _n
file write tex "" _n
