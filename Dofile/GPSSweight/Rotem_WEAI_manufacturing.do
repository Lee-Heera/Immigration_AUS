...
drop if growmanu_share == . /// obs=2,411 

tabulate year, generate(year_)

* residualize y
xi: reg growmanu_share D1_share_popfifold D1_share_college year_2-year_5 i.LGAFINAL21, cl(LGAFINAL21)
predict yhat, xb
gen p_t_res = growmanu_share - yhat
...
cd "/Users/ihuila/Desktop/data/2025ABS/tables/rotem/manufacturing"
est clear
...
save "Rotemberg_manu_results.dta", replace
**********************************
...
sum abs_alpha if KPF >=5 & KPF <=400 // abs_alpha 모두 양수임 
sum KPF Beta 

***********manufacturing만 figure에서 negative weight 이 없어서 figure code 그림이 다름
...
save "/Users/ihuila/Desktop/data/2025ABS/tables/rotem/manufacturing/panelII_top5_table.dta", replace
...
file write tex "\caption{Summary of Rotemberg weights -- Manufacturing Employment}" _n
file write tex "\label{apt:rotemberg_manu}" _n
file write tex "" _n
