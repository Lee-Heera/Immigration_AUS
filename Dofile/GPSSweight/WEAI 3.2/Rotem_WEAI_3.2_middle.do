...
* residualize y
xi: reg share_midsk $demo year_1-year_5 i.LGAFINAL21 if sample==1 , cl(LGAFINAL21)
predict yhat, xb
gen p_t_res = share_midsk - yhat
...
scalar b_overall_midsk = _b[immigration_res]
display "Rotemberg base coef  = " %10.6f b_overall_midsk
* MAIN results 의 coefficient 와 일치하는지 확인

cd "/Users/ihuila/Desktop/data/2025ABS/tables/rotem/3-2/middleskill"
...
display "========================================"
display "Overall IV coef      = " %10.6f b_overall_misdk
display "Rotemberg recomposed = " %10.6f b_rotem[1]
display "Difference           = " %10.8f (b_overall_midsk - b_rotem[1])
display "========================================"
drop ab b_rotem
...
use "Rotemberg_midsk_results.dta", clear
...
twoway ///
    ...
    , ///
    yline(`=scalar(b_overall_midsk)', lpattern(dash) lcolor(black) lwidth(medium)) ///
...
file write tex "\caption{Summary of Rotemberg Weights -- Middle skill}" _n
file write tex "\label{TA:rotem_midsk}" _n
