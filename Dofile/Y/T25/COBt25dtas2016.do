...
import excel using 1.XLS, sheet("T 25a") clear
keep A-L N 
...
ren E mort4 //600-799
ren F mort5 //800-999
ren G mort6 //1000-1399
ren H mort7 //1400-1799
ren I mort8 //1800-2399 
ren J mort9 //2400-2999
ren K mort10 //3000-3999
ren L mort11 //4000 and over 
ren N morttot // total 
...
***** 2006년 
forvalues i = 1(1)544 {
import excel using `i'.XLS, sheet("T 25a") clear
keep A
keep in 2
ren A lga_info
compress
...
save /Users/ihuila/Desktop/data/2025ABS/afterABS10/2016/cob`i'_ver1.dta, replace
}
