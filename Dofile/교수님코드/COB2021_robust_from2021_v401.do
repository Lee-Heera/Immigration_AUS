...
cd "D:\Dropbox\0_02_Jun_Research\ABS_Census\2021\COBdtas"

* LGA merge codes
import excel using "D:\Dropbox\0_02_Jun_Research\ABS_Census\LGA_new_crosswalk2001_2016\LGAFINAL_ALL_2021H.xlsx", sheet("LGA2021") first clear
sort LGA2021
drop lga_code2021
tempfile lgacode
...
use cob1.dta, clear
ren A cob
replace cob = "Born elsewhere(e)" if (cob=="Afghanistan" | cob=="Bangladesh" | cob=="Iran" | cob=="Nepal" | cob=="Pakistan" | cob=="Country of birth not stated")
replace cob = "Born elsewhere(e)" if (cob=="Taiwan" | cob=="Croatia" )
...
sort LGAFINAL21 cob
save "COB2021_robust_from2021_v401.dta", replace


use "TEMP_2021_from2021_v401.dta", clear
...
save "COB2021_robust_from2021_v401_LGAFINAL21_H.dta", replace
