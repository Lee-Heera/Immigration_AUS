...
*******************************************************************
*******************************Version 2.3.*************************
cd "/Users/ihuila/Desktop/data/2025ABS/tables/2-3"
*********************** Table 1 -> 여기부터 코드 수정 
// Table1 (Panel A)
est clear 

xi: reg dlog_unemployed Xit2 i.year  if sample==1, vce(cluster LGAFINAL21)
est store reg1 

xi: reg dlog_manu_tot Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg2 

xi: reg dlog_service_tot Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg3 
...
// Table 1 (Panel B) : FE
est clear
xi: xtivreg2 dlog_unemployed Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_manu_tot Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_service_tot Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m3 
...
est clear 
xi: xtivreg2 dlog_unemployed (Xit2 = Zit2) i.year $demo if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_manu_tot (Xit2 = Zit2) i.year $demo if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_service_tot (Xit2 = Zit2) i.year $demo if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m3 
...
xi: reg dlog_consum_serv Xit2 i.year  if sample==1, vce(cluster LGAFINAL21)
est store reg1 

xi: reg dlog_produc_serv Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg2 

xi: reg dlog_public_serv Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg3 
...
// Table 1 (Panel B) : FE
est clear
xi: xtivreg2 dlog_consum_serv Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_produc_serv Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_public_serv Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m3 
...
// Table 1 (Panel C) : FE-IV estimation 
est clear 
xi: xtivreg2 dlog_consum_serv (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1 

xi: xtivreg2 dlog_produc_serv (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_public_serv (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_)  
est store m3 
...
xi: reg dlog_highsk_tot Xit2 i.year  if sample==1, vce(cluster LGAFINAL21)
est store reg1 

xi: reg dlog_midsk_tot Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg2 

xi: reg dlog_lowsk_tot Xit2 i.year if sample==1, vce(cluster LGAFINAL21)
est store reg3 
...
// Table 1 (Panel B) : FE
est clear
xi: xtivreg2 dlog_highsk_tot Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_midsk_tot Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_lowsk_tot  Xit2 i.year if sample==1, fe cluster(LGAFINAL21) savefprefix(fs_) 
est store m3 
...
// Table 1 (Panel C) : FE-IV estimation 
est clear 
xi: xtivreg2 dlog_highsk_tot (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1 

xi: xtivreg2 dlog_midsk_tot (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_lowsk_tot (Xit2 = Zit2) i.year $demo  if sample==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_)  
est store m3 
...
est clear 
xi: xtivreg2 dlog_unemployed (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_manu_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_service_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m3 

xi: xtivreg2 dlog_unemployed (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m4

xi: xtivreg2 dlog_manu_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m5 

xi: xtivreg2 dlog_service_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m6 
...
est clear 
xi: xtivreg2 dlog_consum_serv (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_produc_serv (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_public_serv (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m3 

xi: xtivreg2 dlog_consum_serv (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m4

xi: xtivreg2 dlog_produc_serv  (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m5 

xi: xtivreg2 dlog_public_serv (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m6 
...
est clear 
xi: xtivreg2 dlog_highsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m1

xi: xtivreg2 dlog_midsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m2 

xi: xtivreg2 dlog_lowsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==1, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m3 

xi: xtivreg2 dlog_highsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m4

xi: xtivreg2 dlog_midsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m5 

xi: xtivreg2 dlog_lowsk_tot (Xit2 = Zit2) i.year $demo if sample==1&metro2==0, fe cluster(LGAFINAL21) robust first savefprefix(fs_) 
est store m6 
